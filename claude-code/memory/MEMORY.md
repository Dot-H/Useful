...
- [FormulaDiff throughput ceiling (GREAT-79)](great79-formula-diff-throughput-ceiling.md) -- x5/x6 = ~44 Active-run orgs (458 Paused) x min(8, IMP share) burst quota; per-diff only ~3s median/~6s avg (measure from compute-api log @duration, NOT sampled APM); ~16k/h eu1, ~27/460 slots used; Notion 3a0adbe6acf580cfa4c6f55a430a63da
