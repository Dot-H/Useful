...
- [IMP executor side-binding limit (GREAT-90)](great90-imp-executor-side-binding-limit.md) — ImpResult.ProcessOuterJoin throws unless every JoinInput SideBinding column also has a matching KeyBinding; unrelated to lazy-load pushdown
