...
- [Directional partial graph cache v2 (SCHED-646)](dg-directional-partial-graph-cache.md) -- 2026-09-08 design: per-column Source/Target claims, SQL CTEs as region loaders, FF 50084 partial-for-all; prod numbers: 175k-node org has p99 downstream region of 347 nodes, hubs up to 27k readers
